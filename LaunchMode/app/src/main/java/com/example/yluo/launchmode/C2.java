...
public class C2 extends Activity implements View.OnClickListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        Toast.makeText(this, "C2 onCreate", Toast.LENGTH_SHORT).show();
    ...
    protected void onNewIntent(Intent intent) {
        ...
        Toast.makeText(this,"C2 onNewIntent",Toast.LENGTH_SHORT).show();
    }
